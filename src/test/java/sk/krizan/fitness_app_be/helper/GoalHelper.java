...
import sk.krizan.fitness_app_be.controller.request.goal.GoalCreateRequest;
import sk.krizan.fitness_app_be.controller.request.goal.GoalFilterRequest;
import sk.krizan.fitness_app_be.controller.request.goal.GoalUpdateRequest;
...
public class GoalHelper {
    ...
    public static void assertFilter(
        ...
        List<GoalResponse> results = response.getResults();
